...
import static com.loopitis.endpoints.RequestsEndpoint.generateCancelLink;
import static com.loopitis.endpoints.RequestsEndpoint.generateShowRequest;
...
public class HttpNotifier {
    ...
    public HttpNotifier(HttpNotifierRequestTranslated notif) {
